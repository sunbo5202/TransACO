...
def main(n_node, model_file, k_sparse = None, n_ants=80, t_aco = None):
    k_sparse =k_sparse or n_node
    t_aco = None or list(range(1,2))
...
if __name__ == "__main__":
    ...
    parser.add_argument("-m", "--model", type=str, default=None, help=f"Path to checkpoint file, default to '../pretrained/tsp_nls/tsp2opt500-best.pt'")
    opt = parser.parse_args()
    n_nodes = opt.nodes

    filepath = opt.model or f'../pretrained/tsp_nls/tsp2opt500-best.pt'
